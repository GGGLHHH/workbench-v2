...
// 本地修正:仓库开了 verbatimModuleSyntax,类型必须走 type-only import
...
interface AnimatedItemProps {
  ...
  /** 本地增补:容器自己排版时要能去掉默认的 mb-4/cursor-pointer */
  className?: string;
}

// 本地增补 export:项目列表只用得上这半个组件(入场动画),
// 下面那半个自带滚动容器/渐变/滚动条,与 ScrollArea + useScrollFade 冲突。
